    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            ...
            <div style="display: flex; align-items: center; gap: 1rem; margin: 1.5rem 0;">
                ...
                <span style="color: var(--text-muted); font-size: 0.8rem;">or sign in with</span>
                <div style="flex: 1; height: 1px; background: var(--border);"></div>
            </div>

            <a href="{{ route('auth.google') }}" style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 0.75rem; background: var(--gk-dark); border: 1px solid var(--border); border-radius: 8px; color: var(--text); font-size: 0.9rem; font-weight: 500; text-decoration: none; transition: all 0.2s ease;">
