...
/*
|--------------------------------------------------------------------------
| Stripe Webhook (must be before any middleware that verifies CSRF)
|--------------------------------------------------------------------------
*/
...
// Profile management - redirect views to account settings, keep API routes
Route::middleware('auth')->group(function () {
    Route::get('/profile', fn() => redirect()->route('account.settings'))->name('profile.edit');
    Route::get('/profile/show', fn() => redirect()->route('account.settings'))->name('profile.show');
